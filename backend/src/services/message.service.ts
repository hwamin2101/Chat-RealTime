...
async function getAIResponse(chatId: string, userId: string) {
  ...
  if (!whopAI) throw new NotFoundException("Whop AI user not found");
  ...
  const result = await streamText({
    ...
    system: "You are Whop AI, an AI assistant for Whop.com platform. Provide helpful and concise responses.",
  });
